    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Report NG Customer by Customer</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                ...
                $get = $this->input->get();
                if (count($detail_data) > 0) {
                    echo '<a href="'.base_url('report/filterbycust?startdate=' . $get['startdate'] . '&enddate=' . $get['enddate'] . '&customer='.$get['customer'] .'').'" target="_blank" class="btn btn-success" id="btn-print"> <i class="fa fa-print"></i> Print</a>';
                }else{
