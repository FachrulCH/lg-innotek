                    ...
                    <tbody>
                        ...
                        if (count($detail_data) > 0) {
                            foreach ($detail_data as $idx => $detail) {
                                $tgl = (is_null($detail['car_sub_date'])) ? '(kosong)' : format_tgl($detail['car_sub_date']);
                                $desc = (is_null($detail['car_description'])) ? '(kosong)' : $detail['car_description'];
                                ...
                                if ($detail['car_file_name'] !== null) {
                                    echo'<a href="' . base_url() . 'unduh/file/' . $detail['car_file_name'] . '" class="btn btn-success btn-xs btn-download"><i class="fa fa-download"></i> Download</a> ';
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                <?php echo form_open_multipart('history/simpanngcar'); ?>
                <form class="form-horizontal">
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure to delete this file upload and rollback to <b>Progress 2</b>?</p>
            </div>
            <div class="modal-footer">
                <form action="<?= base_url('history/hapusngcar') ?>" method="post">
