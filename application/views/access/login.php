  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?=base_url();?>"><img src="<?=base_url('assets/img/logo-innotek.png');?>" alt="Lg:innotek"/></a>
      </div><!-- /.login-logo -->
      ...
      <div class="login-box-body">
        ...
        <?php 
            ...
            if (@$pesan){
                echo'<div class="alert alert-danger"><button class="close" data-dismiss="alert" type="button">×</button>'.$pesan.'</div>';
            }
        ?>
          <div class="form-group has-feedback">
              <input type="text" name="usermail" 
                     class="form-control" placeholder="User Id" autofocus="" value="<?php echo set_value('usermail'); ?>"/>
